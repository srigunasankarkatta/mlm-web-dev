      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className={styles.pageHeader}>
          ...
          <p className={styles.pageSubtitle}>
            Start with Package-1 ($20) and unlock higher levels as you grow. Each package opens new income opportunities.
          </p>
        </div>
        ...
        <div className={styles.eligibilitySection}>
          ...
          <div className={styles.eligibilityRules}>
            <div className={styles.ruleCard}>
              ...
              <p className={styles.ruleDescription}>All users must start with Package-1 ($20) to access the platform</p>
            </div>
            <div className={styles.ruleCard}>
              <div className={styles.ruleTitle}>
              ...
              <p className={styles.ruleDescription}>Higher packages unlock higher level income streams</p>
            </div>
            <div className={styles.ruleCard}>
              <div className={styles.ruleTitle}>
              ...
              <p className={styles.ruleDescription}>Each level provides percentage-based income from your network</p>
            </div>
            <div className={styles.ruleCard}>
              <div className={styles.ruleTitle}>
              ...
              <p className={styles.ruleDescription}>All packages include auto pool progression benefits</p>
            </div>
          </div>
        </div>
              ...
              <div className={styles.planContent}>
                ...
                <button
                  ...
                  className={`${styles.actionButton} ${
                    plan.isRequired ? styles.primaryButton : styles.secondaryButton
                  }`}
                >
        ...
        <div className={styles.comparisonSection}>
          ...
          <div className={styles.comparisonTable}>
            <div className={styles.tableHeader}>
              ...
              <div className={styles.headerSubtitle}>See what each package unlocks</div>
            </div>
            <div className={styles.tableBody}>
              ...
              <div className={styles.tableRow}>
                ...
                {MLM_PLANS.map((plan) => (
                  <div key={plan.id} className={styles.tableCell}>
                    {plan.unlocks.includes('Level') ? `L${plan.level}` : (
                      <span className={styles.featureIcon + ' ' + styles.cross}>✗</span>
                    )}
                  </div>
                ))}
