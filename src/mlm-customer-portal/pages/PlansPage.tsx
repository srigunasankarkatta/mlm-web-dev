          ...
          <div className={styles.pageHeader}>
            ...
            {packagesError && (
              <div className={styles.errorBanner}>
                <p>
                  ⚠️ Using cached data. Some packages may not be up to date.
                </p>
                <button
            ...
            <div className={styles.eligibilityRules}>
              <div className={styles.ruleCard}>
                ...
                <p className={styles.ruleDescription}>
                  All users must start with Package-1 (₹20) to access the
                  platform
                </p>
              </div>
              <div className={styles.ruleCard}>
                  ...
                  {packages.map((plan) => (
                    <div key={plan.id} className={styles.tableCell}>
                      {plan.unlocks.includes("Direct") ? (
                        <span
                          className={styles.featureIcon + " " + styles.check}
                        >
                          ✓
                        </span>
                      ) : (
                        <span
                          className={styles.featureIcon + " " + styles.cross}
                        >
                          ✗
                        </span>
                      )}
