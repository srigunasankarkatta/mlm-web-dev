...
const IncomeBreakdownCard: React.FC<IncomeBreakdownCardProps> = ({ income }) => {
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100 overflow-hidden">
      <div className={`bg-gradient-to-r ${getColorClass(income.type)} p-6 text-white`}>
        ...
        {income.maxDirects && (
          <div className="bg-gray-50 rounded-lg p-3 mb-3">
            <p className="text-sm text-gray-700">
              <span className="font-semibold">Max Directs:</span> {income.maxDirects}
            </p>
          </div>
        )}
