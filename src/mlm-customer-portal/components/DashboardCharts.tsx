...
const DashboardCharts: React.FC<DashboardChartsProps> = ({ incomeSummary }) => {
  ...
  const pieData = [
    {
      name: "Direct Income",
      value: incomeSummary.directIncome.total,
      color: "#14b8a6",
    },
    {
      name: "Level Income",
      value: incomeSummary.levelIncome.total,
      color: "#3b82f6",
    },
    {
      name: "Club Income",
      value: incomeSummary.clubIncome.total,
      color: "#10b981",
    },
    {
      name: "Auto Pool",
      value: incomeSummary.autoPoolIncome.total,
      color: "#8b5cf6",
    },
  ];
  ...
  const directData = incomeSummary.directIncome.breakdown.map(
    (item, index) => ({
  ...
  const autoPoolData = [
    {
      level: "Level 1",
      members: 4,
      current: incomeSummary.autoPoolIncome.currentLevel >= 1,
    },
    {
      level: "Level 2",
      members: 16,
      current: incomeSummary.autoPoolIncome.currentLevel >= 2,
    },
    {
      level: "Level 3",
      members: 64,
      current: incomeSummary.autoPoolIncome.currentLevel >= 3,
    },
  ];
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-800">
                ₹
                {(
                  incomeSummary.directIncome.total +
                  incomeSummary.levelIncome.total +
                  incomeSummary.clubIncome.total +
                  incomeSummary.autoPoolIncome.total
                ).toFixed(2)}
              </p>
            </div>
